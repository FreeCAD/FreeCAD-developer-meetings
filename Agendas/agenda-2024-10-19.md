...
2. V1.0 release process and blocker bounties. (sliptonic)
   ...
   - Discussion whether to include [PR #17119](https://github.com/FreeCAD/FreeCAD/pull/17119/) (Add Fuzzyness to boolean operations) into V1.0 and what testing is needed.
   - 
